...
export default function TypeScriptCoursePage() {
  ...
  const [lessons] = useState<Lesson[]>([
    { id: 1, title: "Generics Fundamentals", duration: "28 min", isCached: true, cachePercentage: 100, isCompleted: true },
    { id: 2, title: "Advanced Type Guards", duration: "32 min", isCached: true, cachePercentage: 100, isCompleted: true },
    { id: 3, title: "Decorators & Metadata", duration: "35 min", isCached: true, cachePercentage: 85, isCompleted: false },
    { id: 4, title: "Conditional Types", duration: "30 min", isCached: false, cachePercentage: 0, isCompleted: false },
    { id: 5, title: "Utility Types Deep Dive", duration: "38 min", isCached: false, cachePercentage: 0, isCompleted: false },
    { id: 6, title: "Advanced Patterns", duration: "42 min", isCached: false, cachePercentage: 0, isCompleted: false },
  ]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-r from-orange-500 to-orange-700 rounded-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Advanced TypeScript Patterns</h1>
          <p className="text-orange-100">Master advanced TypeScript concepts and patterns for professional development</p>
          <p className="text-orange-100 mt-2">Instructor: Sarah Chen • 24 lessons • 8h 30m</p>
        </div>
          ...
          <div className="bg-slate-700 p-6 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-white">8h 30m</p>
              </div>
